...
const AboutSection = () => {
  const values = [
    {
      icon: <Award className="w-8 h-8 text-corporate-blue-600" />,
      title: "Profissionalismo",
      description: "Compromisso com a excelência em cada projeto"
    },
    {
      icon: <Target className="w-8 h-8 text-corporate-blue-600" />,
      title: "Personalização",
      description: "Soluções adaptadas às suas necessidades específicas"
    },
    {
      icon: <Users className="w-8 h-8 text-corporate-blue-600" />,
      title: "Rede Sólida",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div className="animate-slide-in-right">
            <h3 className="text-2xl font-heading font-semibold text-neutral-elegant-900 mb-6">
              Liderança e Visão
            </h3>
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-neutral-elegant-200">
                <h4 className="text-xl font-semibold text-corporate-blue-700 mb-3">Raquel Ferrage - CEO</h4>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-neutral-elegant-200">
                <h4 className="text-xl font-semibold text-corporate-blue-700 mb-3">Fábio Sousa Ferrage</h4>
                <p className="text-neutral-elegant-600 leading-relaxed">
          ...
          <div className="animate-fade-in-up">
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-neutral-elegant-200">
              ...
              <div className="space-y-6">
                {values.map((value, index) => (
                  <div key={index} className="flex items-start gap-4">
                    <div className="flex-shrink-0 p-3 bg-corporate-blue-50 rounded-lg">
                      {value.icon}
                    </div>
                    <div>
                      <h4 className="text-lg font-semibold text-neutral-elegant-900 mb-2">
                        {value.title}
                      </h4>
                      <p className="text-neutral-elegant-600">
                        {value.description}
                      </p>
                    </div>
                  </div>
